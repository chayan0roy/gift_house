...
export default function BuyPage({ buyProductData, addToCart }) {
    ...
    let productPrice = buyProductData.price - ((buyProductData.price * buyProductData.offer) / 100);
    ...
    return (
        <div className='buyPage flex'>
            ...
            <div className='productDetailsArea'>
                ...
                <h3 className='productPriceArea flex3'><span>Product Price</span><span data-decoration="deleted">{buyProductData.productPrice * productItem}</span><span>{(buyProductData.productPrice - ((buyProductData.productPrice * buyProductData.offer) / 100)) * productItem}</span></h3>
                ...
                <div className='btnArea flex2'>
                    <button className='btnAreaBtn btn' to="/buyPage" >Buy</button>
                    <button className="btnAreaBtn btn" onClick={() => addToCart(buyProductData)}>
